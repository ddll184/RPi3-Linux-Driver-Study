...
1.  **准备工作 (Linux 虚拟机)**
    *   在 VMware Workstation / Player 中安装 Linux 发行版 (推荐使用 Ubuntu 20.04/22.04 LTS)。
...
5.  **部署与验证 (SD Card & RPi3)**
    *   将SD卡读写器连接到电脑，并在 VMware 中将其连接到虚拟机。
    *   在虚拟机中挂载SD卡分区，并将编译产物部署到对应分区。
